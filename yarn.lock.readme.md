...
- locked dependencies allow us to detect when node_modules folder is out of date after a branch switch. It allows us to build the project with the correct dependencies every time
